package com.company.food_online_service.exception_handler;
...
public class FoodExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleFoodException(FoodException foodException){
        return ResponseEntity.ok(new Response(null, foodException.getMessage()));
    }
}
